...
public class SocketListener {
    ...
    public static final String LISTEN_ADDRESS = NeoTermConstants.NEOTERM_API_PACKAGE_NAME + "://listen";
                ...
                try (LocalServerSocket listen = new LocalServerSocket(LISTEN_ADDRESS)) {
                    while (true) {
                        try (LocalSocket con = listen.accept();
                            ...
                            // only accept connections from NeoTerm programs
                            ...
                            try {
                                ...
                                Intent intent = new Intent(app.getApplicationContext(), NeoTermApiReceiver.class);
