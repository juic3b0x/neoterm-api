...
public abstract class ResultReturner {
    ...
    public static abstract class WithAncillaryFd implements ResultWriter {
        ...
        public final void sendFd(PrintWriter out, int fd) {
            ...
            // expected as the message by the native `neoterm-api` command when a fd is sent.
            // - https://github.io.neoterm/neoterm-api-package/blob/e62bdadea3f26b60430bb85248f300fee68ecdcc/neoterm-api.c#L358
            out.print("@");
    ...
    /**
     * Just tell neoterm-api.c that we are done.
     */
    ...
    public static void returnData(Object context, final Intent intent, final ResultWriter resultWriter) {
        ...
        final Runnable runnable = () -> {
            ...
            try {
                ...
                NeoTermPluginUtils.sendPluginCommandErrorNotification(ResultReturner.context, LOG_TAG,
