...
public class StorageGetAPI {
    ...
    private static final String FILE_EXTRA = NeoTermConstants.NEOTERM_API_PACKAGE_NAME + ".storage.file";
    ...
    public static void onReceive(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
        ...
        ResultReturner.returnData(apiReceiver, intent, out -> {
            ...
            String filePath = NeoTermFileUtils.getCanonicalPath(fileExtra, null, true);
