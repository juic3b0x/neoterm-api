...
public class InfraredAPI {
    ...
    public static void onReceiveCarrierFrequency(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    public static void onReceiveTransmit(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
