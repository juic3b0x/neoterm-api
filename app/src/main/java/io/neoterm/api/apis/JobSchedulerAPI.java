...
public class JobSchedulerAPI {
    ...
    public static void onReceive(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
    ...
    private static void displayPendingJobs(NeoTermApiReceiver apiReceiver, Intent intent, JobScheduler jobScheduler) {
    ...
    private static void cancelJob(NeoTermApiReceiver apiReceiver, Intent intent, JobScheduler jobScheduler, int jobId) {
    ...
    public static class JobSchedulerService extends JobService {
        ...
        public static final String SCRIPT_FILE_PATH = NeoTermConstants.NEOTERM_API_PACKAGE_NAME + ".jobscheduler_script_path";
        ...
        public boolean onStartJob(JobParameters params) {
            ...
            executionCommand.executableUri = new Uri.Builder().scheme(NEOTERM_SERVICE.URI_SCHEME_SERVICE_EXECUTE).path(filePath).build();
