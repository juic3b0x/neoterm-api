...
public class TelephonyAPI {
    ...
    public static void onReceiveTelephonyCellInfo(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    public static void onReceiveTelephonyDeviceInfo(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    public static void onReceiveTelephonyCall(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
