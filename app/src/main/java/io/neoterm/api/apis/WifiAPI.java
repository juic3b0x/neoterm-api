...
public class WifiAPI {
    ...
    public static void onReceiveWifiConnectionInfo(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    public static void onReceiveWifiScanInfo(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    public static void onReceiveWifiEnable(NeoTermApiReceiver apiReceiver, final Context context, final Intent intent) {
