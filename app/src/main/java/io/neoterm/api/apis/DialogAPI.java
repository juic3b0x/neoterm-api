...
import io.neoterm.shared.theme.ThemeUtils;
import io.neoterm.shared.view.KeyboardUtils;
...
public class DialogAPI {
    ...
    public static class DialogActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            NeoTermThemeUtils.setAppNightMode(context);
        ...
        public static class BottomSheetInputMethod extends BottomSheetDialogFragment implements InputMethod {
             ...
             * we are still within the NeoTerm application
             */
            ...
            /**
             * Checks to see if foreground application is NeoTerm
             */
            protected boolean isCurrentAppNeoTerm() {
                ...
                for (final ActivityManager.RunningAppProcessInfo processInfo : runningProcesses) {
                    if (processInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                        for (final String activeProcess : processInfo.pkgList) {
                            if (activeProcess.equals(NeoTermConstants.NEOTERM_PACKAGE_NAME)) {
                                return true;
                            }
                        }
                    }
        ...
        static class SpeechInputMethod extends InputDialog<TextView> {
            ...
            public void create(final AppCompatActivity activity, final InputResultListener resultListener) {
                ...
                if (!NeoTermApiPermissionActivity.checkAndRequestPermissions(activity, activity.getIntent(), Manifest.permission.RECORD_AUDIO)) {
                    activity.finish();
                }
