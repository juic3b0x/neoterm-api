...
public class SAFAPI {
    ...
    private static void getManagedDocumentTrees(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
    ...
    private static void writeDocument(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
    ...
    private static void createDocument(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
    ...
    private static void readDocument(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
        String uri = intent.getStringExtra("uri");
        if (uri == null) {
            Logger.logError(LOG_TAG, "uri extra null");
            return;
    ...
    private static void listDirectory(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
        String treeURIString = intent.getStringExtra("treeuri");
        if (treeURIString == null) {
            Logger.logError(LOG_TAG, "treeuri extra null");
            return;
    ...
    private static void statURI(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
    ...
    private static void removeDocument(NeoTermApiReceiver apiReceiver, Context context, Intent intent) {
        String uri = intent.getStringExtra("uri");
        if (uri == null) {
            Logger.logError(LOG_TAG, "uri extra null");
            return;
    ...
    private static void returnDocumentFile(NeoTermApiReceiver apiReceiver, Context context, Intent intent, DocumentFile f) {
    ...
    private static void writeDocumentFile(NeoTermApiReceiver apiReceiver, Context context, Intent intent, DocumentFile f) {
